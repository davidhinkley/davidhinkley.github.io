...
| `python-course-guide.html` | **Foundations guide as a web page** ([live](https://davidhinkley.github.io/python-course-guide.html)) — same content as `python-course.md`, styled for remote visitors. |
| `Pyf-icon.svg` | Foundations icon (`Pyf` badge). Favicon / brand icon for `python-course.html` and `index.html`. |
| `python-course.md` | Foundations guide source — the friendly manual for the beginner course (rendered on GitHub; remote visitors get the HTML version above). |
| `python-intermediate.html` | **The whole Intermediate course.** Content + browser runtime in one self-contained file. |
| `python-intermediate-guide.html` | **Intermediate guide as a web page** ([live](https://davidhinkley.github.io/python-intermediate-guide.html)) — same content as `python-intermediate.md`, styled for remote visitors. |
| `PyI-icon.svg` | Intermediate icon (`PyI` badge). Favicon / brand icon for `python-intermediate.html` and `index.html`. |
| `python-intermediate.md` | Intermediate guide source — the friendly manual for the follow-on course (rendered on GitHub; remote visitors get the HTML version above). |
